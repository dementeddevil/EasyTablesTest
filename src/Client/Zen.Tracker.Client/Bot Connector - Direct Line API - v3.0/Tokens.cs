...
namespace Zen.Tracker.Client
{
    ...
    /// Tokens operations.
    /// </summary>
    public partial class Tokens : IServiceOperations<BotConnectorDirectLineAPIV30>, ITokens
    {
        /// <summary>
        ...
        /// </param>
        public Tokens(BotConnectorDirectLineAPIV30 client)
        {
            if (client == null) 
            {
        ...
        /// </summary>
        public BotConnectorDirectLineAPIV30 Client { get; private set; }
        ...
        public async Task<HttpOperationResponse<Conversation>> RefreshTokenWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<Conversation>(_responseContent, Client.DeserializationSettings);
                }
