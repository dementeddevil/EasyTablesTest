...
namespace Zen.Tracker.Client
{
    ...
    public static partial class ConversationsExtensions
    {
            ...
            /// <param name='userId'>
            /// </param>
            public static ResourceResponse Upload(this IConversations operations, string conversationId, System.IO.Stream file, string userId = default(string))
            {
                return Task.Factory.StartNew(s => ((IConversations)s).UploadAsync(conversationId, file, userId), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ResourceResponse> UploadAsync(this IConversations operations, string conversationId, System.IO.Stream file, string userId = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
